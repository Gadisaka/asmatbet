        ...
        <SoftPanel className="animate-deposit-panel">
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <label className="flex items-start gap-3">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (checked) setAgeError("");
                  }}
                  aria-invalid={ageError ? true : undefined}
                  aria-describedby={ageError ? "register-age-error" : undefined}
                  className="mt-0.5 h-4 w-4 shrink-0 accent-[#8FCF4A]"
                />
                <span className="text-xs font-semibold leading-relaxed text-[rgba(255,255,255,0.72)]">
                  {t("register.ageConfirm")}
                </span>
              </label>
              {ageError ? (
                <p
                  id="register-age-error"
                  role="alert"
                  className="mt-2 text-xs font-semibold text-[#ff6b6b]"
                >
                  {ageError}
                </p>
              ) : null}
            ...
            <div className="relative py-2">
              <div
                className="absolute inset-x-0 top-1/2 h-px bg-[#8FCF4A]/80"
                aria-hidden
              />
