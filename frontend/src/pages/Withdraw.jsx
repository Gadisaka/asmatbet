          ...
          <div className="flex flex-col gap-4">
            ...
            <SoftPanel className="animate-deposit-panel">
              ...
              <p className="mt-2 m-0 text-center text-[11px] leading-relaxed text-[rgba(255,255,255,0.5)]">
                Only winnings can be withdrawn. Unused deposits stay locked
                until they are wagered and paid out as a win.
              </p>
            </SoftPanel>
            ...
            {result ? (
              <SoftPanel
                className="animate-deposit-panel bg-[#111111] ring-[#3f7f5f]/35"
                style={{
                  background:
