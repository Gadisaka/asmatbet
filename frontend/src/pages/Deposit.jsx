        ...
        return (
          <div
            ...
            className={`h-2.5 rounded-full transition-all duration-500 ease-out ${
              active
                ? "w-9 bg-(--sb-accent-fill) shadow-[0_0_14px_rgba(143,207,74,0.45)]"
                : done
...
function Deposit() {
  ...
  async function submitOnline() {
    ...
    setSubmitting(true);
    try {
      const data = await submitOnlineDeposit({
        method,
        amount: n,
    ...
    <PageContainer>
      ...
      <div className="relative mx-auto w-full max-w-lg px-4 pb-28 pt-2 sm:px-5 sm:pt-4">
        ...
        <div className="relative mb-8 flex rounded-full bg-[#0a0a0a]/85 p-1.5 shadow-inner shadow-black/30  backdrop-blur-md">
          <div
            className={`absolute inset-y-1.5 w-[calc(50%-6px)] rounded-full bg-(--sb-accent-fill) shadow-[0_8px_24px_rgba(143,207,74,0.35)] transition-all duration-500 ease-out ${
        ...
        {depositTab === "shop" ? (
          ...
          <div className="flex flex-col items-center justify-center gap-5 py-24">
            <div className="relative h-14 w-14">
              ...
              <div className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#111111] ring-2 ring-(--sb-accent-fill)/40">
                <div className="h-7 w-7 animate-spin rounded-full border-2 border-[#8FCF4A] border-t-(--sb-accent-fill)" />
              </div>
            </div>
          ...
          <div className="flex flex-col gap-2">
            <p className="mb-2 px-1 text-center text-sm leading-relaxed text-[rgba(255,255,255,0.72)]">
              Pay in your banking app, then paste the SMS. The amount must
              match the verified transfer.
            </p>
            ...
            >
                      ...
                      return (
                        <button
                          ...
                          className={`group relative flex w-full items-center gap-4 overflow-hidden rounded-2xl px-4 py-3.5 text-left transition-all duration-300 ${
                            sel
                              ? "scale-[1.02] bg-gradient-to-r from-(--sb-accent-surface)/90 via-[#111111] to-[#111111] shadow-[0_12px_32px_-12px_rgba(143,207,74,0.35)] ring-2 ring-(--sb-accent-fill)/70"
              ...
              {onlineStep === 4 && onlineResult && (
                <SoftPanel
                  className={
                    onlineResult.ok
                      ? "bg-[#111111] shadow-[0_0_0_1px_rgba(95,227,214,0.2),0_24px_48px_-20px_rgba(20,36,20,0.6)]"
                      : "bg-[#111111] shadow-[0_0_0_1px_rgba(255,107,107,0.15),0_24px_48px_-20px_rgba(42,20,20,0.5)]"
                  }
                  style={{
                    background:
