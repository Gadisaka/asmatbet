...
After setup, open **https://admin.asmatbet.com** and tickets print silently. No WebUSB, Zadig, browser print dialog, or terminal.
...
- Default key: `michubet-local-print-v1` (change only if you rebuild the cashier app with matching `VITE_PRINTER_API_KEY`)
