  ...
  return (
    <PanelCard className="p-6">
      ...
      <p className="mt-1 text-xs text-[var(--muted)]">
        When enabled, new tickets snapshot this rate. Tax is withheld only from
        the winning amount on WON tickets (online win credits and cashier
        payouts). Open, lost, and void tickets are not taxed. Slips show helper
        text such as "Tax 15% - 12.50 Birr". Cashout offers still use
        the snapshotted rate. Existing tickets keep their snapshot.
      </p>
