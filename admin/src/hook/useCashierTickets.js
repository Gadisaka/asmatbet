...
export function mapTicketRow(ticket) {
  ...
  return {
    ...
    estimatedWinningsTaxAmount: Number(
      ticket.estimated_winnings_tax_amount ??
        ticket.estimatedWinningsTaxAmount ??
        0,
    ),
    winningsTaxHelper:
      ticket.winnings_tax_helper ?? ticket.winningsTaxHelper ?? null,
